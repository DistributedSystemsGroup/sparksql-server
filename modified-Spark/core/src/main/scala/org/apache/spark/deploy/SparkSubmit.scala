...
object SparkSubmit {
  ...
  private[spark] def prepareSubmitEnvironment(args: SparkSubmitArguments)
    ...
    var clusterManager: Int = args.master match {
    ...
    //Change clusterManager to local if sparksql-server is specified
    if(args.sparkSqlServer != null) {
    ...
    val options = List[OptionAssigner](
      ...
      // SparkSQLServer
      OptionAssigner(args.sparkSqlServer, ALL_CLUSTER_MGRS, ALL_DEPLOY_MODES,
        sysProp = "spark.sqlServer"),
      OptionAssigner(args.metadata, ALL_CLUSTER_MGRS, ALL_DEPLOY_MODES,
        sysProp = "spark.metadata"),
      OptionAssigner(args.primaryResource, ALL_CLUSTER_MGRS, ALL_DEPLOY_MODES,
        sysProp = "spark.primaryResource"),
