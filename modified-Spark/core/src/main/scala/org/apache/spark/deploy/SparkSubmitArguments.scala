...
private[spark] class SparkSubmitArguments(args: Seq[String], env: Map[String, String] = sys.env) {
  ...
  var sparkSqlServer: String = null
  ...
  private def loadEnvironmentArguments(): Unit = {
    metadata = Option(metadata)
      .orElse(sparkProperties.get("spark.metadata"))
      .orNull
    sparkSqlServer = Option(sparkSqlServer)
      .orElse(sparkProperties.get("spark.SqlServer"))
      .orElse(env.get("SPARK_SQL_SERVER"))
      .orNull
  ...
  private def parseOpts(opts: Seq[String]): Unit = {
    ...
    def parse(opts: Seq[String]): Unit = opts match {
      ...
      case ("--spark-sql-server") :: value :: tail =>
        sparkSqlServer = value
        parse(tail)
  ...
  private def printUsageAndExit(exitCode: Int, unknownParam: Any = null): Unit = {
    ...
    outStream.println(
      """Usage: spark-submit [options] <app jar | python file> [app arguments]
        ...
        |
        |Options:
        |  --spark-sql-serve           IP address of SparkSQL Server
        |  --metadata                  SparkJob metadata
